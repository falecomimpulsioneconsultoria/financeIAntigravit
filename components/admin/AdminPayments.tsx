    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <h2 className="text-xl font-bold text-gray-900">HistÃ³rico de Pagamentos</h2>
            ...
            <div className="bg-white p-10 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-gray-500 max-w-sm">O extrato detalhado de transaÃ§Ãµes financeiras e integraÃ§Ãµes de checkout serÃ¡ exibido aqui.</p>
            </div>
        </div>
    );
};
