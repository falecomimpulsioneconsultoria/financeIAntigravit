    ...
    <div className="h-full flex flex-col bg-gray-50/30">
      <div className="px-6 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-100 bg-white">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {!ignoreDate && (
            <div className="flex items-center bg-white border border-gray-200 rounded-lg shadow-sm h-[38px]">
              <button
                onClick={() => {
                  if (showCustomRange) {
                ...
                className="px-2 h-full hover:bg-gray-50 text-gray-400 hover:text-blue-600 rounded-l-lg transition-all"
                title={showCustomRange ? "Voltar para seleção mensal" : "Mês Anterior"}
              >
              ...
              {showCustomRange ? (
                <div className="flex items-center gap-2 px-3">
                  <span className="text-[9px] font-black text-blue-500 uppercase">De</span>
                  ...
                  <span className="text-[9px] font-black text-blue-500 uppercase">Até</span>
                ...
                <button
                  ...
                  className="px-4 text-sm font-bold text-gray-700 capitalize hover:text-blue-600 transition-colors min-w-[150px] text-center"
                  title="Clique para intervalo personalizado"
                >
                  {new Date(startDate + "T00:00:00").toLocaleDateString("pt-BR", { month: "long", year: "numeric" })}
                </button>
              )}
              <button
                onClick={() => {
                ...
                className="px-2 h-full hover:bg-gray-50 text-gray-400 hover:text-blue-600 rounded-r-lg transition-all"
                title={showCustomRange ? "Voltar para seleção mensal" : "Próximo Mês"}
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all h-[38px] ${
              showFilters
          ...
          <button
            onClick={() => document.dispatchEvent(new CustomEvent("open-new-transaction"))}
            className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-bold hover:bg-blue-700 transition-all shadow-md shadow-blue-500/20 active:scale-95 h-[38px]"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
