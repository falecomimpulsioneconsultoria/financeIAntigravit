...
const DreHierarchyLabel = ({ code }: { code?: DreCategory }) => {
    ...
    return (
        <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-1.5 text-xs text-gray-600">
            ...
            <span className="hidden sm:inline text-gray-300">â€º</span>
            ...
            <div className="flex flex-col xl:flex-row justify-between items-center gap-6">
                ...
                {canManage && (
                    <div className="flex gap-2 w-full xl:w-auto order-1 xl:order-2">
                        <Button onClick={() => setIsAiModalOpen(true)} variant="secondary" className="w-full xl:w-auto bg-emerald-50 text-emerald-700 border-emerald-200 hover:bg-emerald-100">
                    ...
                    <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-scale-in">
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="pt-2 flex gap-3">
                                ...
                                <Button onClick={handleGenerateAI} className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white shadow-lg shadow-emerald-500/20" isLoading={isGenerating}>
